...
if(isset($_REQUEST['reg']))
{
	...
	else
	{
		...
		if(!empty($name) && !empty($email) && !empty($phone) && !empty($country) && !empty($uimage))
		{
			
			$sql="INSERT INTO user (uname,uemail,uphone,ucountry,utype,uimage) VALUES ('$name','$email','$phone','$country','$utype','$uimage')";
									...
									<div class="form-group">
									 ...
									 <div class="form-check-inline">
									  <label class="form-check-label">
										<input type="radio" class="form-check-input" name="utype" value="user" checked>Homeowner/Buyer
									  </label>
									</div><!-- FOR MORE PROJECTS visit: codeastro.com -->
									<div class="form-check-inline">
									  <label class="form-check-label">
										<input type="radio" class="form-check-input" name="utype" value="agent">Broker/Agent
									  </label>
									</div>
